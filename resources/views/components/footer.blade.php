<div class="container-fluid bg-dark">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 mt-4 mx-5 border-top">
        <div class="col-md-4">
            <div class="d-flex align-items-center">
                <a href="/" class="mb-3 me-2 mb-md-0 text-white text-decoration-none lh-1">
                    <i class="bi bi-bootstrap-fill"></i>
                </a>
                <span class="mb-3 mb-md-0 text-white">© 2022 MusicAulab, Inc</span>
            </div>
            <span class="mb-3 mb-md-0 text-white">© Created by: Alessio e Giorgia</span>
        </div>
